...
function viewEmployeeByDepartment() {
    ...
    connection.query(query, function (err, res) {
      ...
      console.table(res);
      console.log("Department view is succesful!\n");
  ...
  function promptInsert(roleChoices) {
    ...
    inquirer
      ...
      .then(function (answer) {
        ...
        // inset eomployee with promted input
  ...
  function promptDelete(deleteEmployeeChoices) {
    ...
    inquirer
      ...
      .then(function (answer) {
        ...
        var query = `DELETE employee from which department?`;
      ...
      .prompt([
        {
          type: "list",
          name: "employeeId",
          message: "Which employee do you want to set to this role?",
